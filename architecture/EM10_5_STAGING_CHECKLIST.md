...
**Bugs found** (#): 4, 5, 6, 7 — see Part 2; 4 and 5 fixed and unit-tested same day (see their Status column), 6 (observability) not yet addressed, 7 fixed and unit-tested same day, not yet deployed/manually retested
