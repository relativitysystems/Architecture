...
| Cron sweep bearer secret | `Relativity/services/cronSweepAuthService.js` | `GET /api/integrations/slack/sweep` — strict `Bearer <CRON_SECRET>`, fails **closed** (503) if unconfigured, distinct from a 401 mismatch; `crypto.timingSafeEqual`. |
