...
│   ├── ADR-009-EMAIL-AUTOMATIC-SYNC-SYSTEM-CLOCK.md — superseded (2026-08-26, EM10.6): AIKB's cron tick removed with Automatic Email Ingestion; system-scoped signed envelope lives on for EL3 tool execution
